...
union YYSTYPE
{
#line 33 "compiler_hw3.y" /* yacc.c:355  */
...
static const yytype_uint8 yyrline[] =
{
      ...
      72,    73,    74,    79,    80,    81,    85,    86,    87,    88,
      89,    90,    91,    92,    93,    98,    99,   100,   101,   102,
     103,   104,   105,   106,   107,   108,   109,   110,   111,   112,
     113,   116,   117,   121,   122,   123,   124,   127
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 58 "compiler_hw3.y" /* yacc.c:1646  */
    {line++;}
...
#line 71 "compiler_hw3.y" /* yacc.c:1646  */
    {create_symbol();temp=(yyvsp[-3].i_val);num=(yyvsp[0].f_val);symtab[(int)(yyvsp[-3].i_val)]=(yyvsp[0].f_val);c++;insert_symbol(1);fputs("ldc\t",file);fprintf(file,"%f\n",(yyvsp[0].f_val));fputs("fstore\t",file);fprintf(file,"%d\n",c);}
#line 1377 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 72 "compiler_hw3.y" /* yacc.c:1646  */
    {create_symbol();temp=(yyvsp[-3].i_val);num=(yyvsp[0].f_val);symtab[(int)(yyvsp[-3].i_val)]=(yyvsp[0].f_val);c++;insert_symbol(0);fputs("ldc\t",file);fprintf(file,"%f\n",(yyvsp[0].f_val));fputs("istore\t",file);fprintf(file,"%d\n",c);}
#line 1383 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 73 "compiler_hw3.y" /* yacc.c:1646  */
    {create_symbol();temp=(yyvsp[-1].i_val);c++;insert_symbol(0);fputs("ldc\t0\n",file);fputs("istore\t",file);fprintf(file,"%d\n",c);}
#line 1389 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 74 "compiler_hw3.y" /* yacc.c:1646  */
    {create_symbol();temp=(yyvsp[-1].i_val);c++;insert_symbol(1);fputs("ldc\t0\n",file);fputs("fstore\t",file);fprintf(file,"%d\n",c);}
...
#line 1431 "y.tab.c" /* yacc.c:1646  */
  ...
  case 20:
#line 89 "compiler_hw3.y" /* yacc.c:1646  */
...
#line 111 "compiler_hw3.y" /* yacc.c:1646  */
    {(yyval.f_val)=symtab[(int)(yyvsp[0].i_val)];int i; for(i=0;i<c+1;i++){if(symbol[i]==(yyvsp[0].i_val)){if(type[i]==0)fprintf(file,"iload\t%d\n",i);if(type[i]==1)fprintf(file,"fload\t%d\n",i);}}}
#line 1539 "y.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 112 "compiler_hw3.y" /* yacc.c:1646  */
    {(yyval.f_val)=(yyvsp[0].i_val);fprintf(file,"ldc %d\n",(yyvsp[0].i_val));}
#line 1545 "y.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 113 "compiler_hw3.y" /* yacc.c:1646  */
    {(yyval.f_val)=(yyvsp[0].f_val);fprintf(file,"ldc %f\n",(yyvsp[0].f_val));fprintf(file,"fstore\t%d\ni2f\nfload\t%d\n",c,c);c++;}
#line 1551 "y.tab.c" /* yacc.c:1646  */
    break;

  case 41:
#line 116 "compiler_hw3.y" /* yacc.c:1646  */
    {printf("print:%f\n",(yyvsp[-1].f_val));fputs("getstatic java/lang/System/out/ Ljava/io/PrintStream;\nswap\ninvokevirtual java/io/PrintStream/print(I)V\n",file);}
...
#line 131 "compiler_hw3.y" /* yacc.c:1906  */
